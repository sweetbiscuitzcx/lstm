...
#        y1 = np.squeeze(y)
#        y_1 = np.squeeze(y_)
#        np.savetxt('true/time_step3.csv', y1[0],delimiter=",")
#        np.savetxt('true/time_step6.csv', y1[1],delimiter=",")
#        np.savetxt('true/time_step9.csv', y1[2],delimiter=",")
#        np.savetxt('pre/time_step3.csv', y_1[0],delimiter=",")
#        np.savetxt('pre/time_step6.csv', y_1[1],delimiter=",")
#        np.savetxt('pre/time_step9.csv', y_1[2],delimiter=",")
